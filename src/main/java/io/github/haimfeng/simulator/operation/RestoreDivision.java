...
public class RestoreDivision implements ArithmeticOperation {
    ...
    public List<StepRecord> execute(Operand op1, Operand op2) {
        ...
        for (int i = 1; i <= m; i++) {
            ...
            String oldA = a;
            String trialA = NumberUtils.addBinary(a, negM);
            ...
            if (trialA.charAt(0) == '0') {
                ...
                qi = '0';
                stepDesc = "$\\texttt{<<}1;\\; A'=A-M=\\mathtt{" + trialA + "}<0;\\; \\text{restore } A;\\; q_{" + i + "}=0$";
            }
